        ...
        <main className="bg-slate-200 min-h-screen text-black">
            ...
            <div className='mx-5 mt-5 flex flex-wrap justify-center gap-4'>
                <Card className="max-w-sm lg:max-w-xs columns-2">
                    <img src="https://fdn2.gsmarena.com/vv/pics/samsung/samsung-galaxy-s24-ultra-5g-sm-s928-0.jpg" alt="Two each of gray, white, and black shirts laying flat." className="h-full w-full object-cover object-center"></img>
                    <div>
                        <h5 className="text-base font-semibold text-gray-900 lg:text-xl dark:text-white">Samsung S24 Ultra</h5>
                        ...
                        <ul className="my-2 space-y-3">
                            <li>
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">Rilis: 31 Januari 2024 </span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">Layar: 6.8" Inch</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">Kamera: 50 MP</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">Snapdragon 8 Gen 3</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">RAM: 12 GB</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">Penyimpanan: 512 GB</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    ...
                                    <span className="ml-3 flex-1 px-2 whitespace-nowrap">Baterai: 5000 mAh</span>
                                </a>
                            </li>
                        </ul>
                    </div>
