  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // });
        router.push(
          `/quizResult?recommendations=${encodeURIComponent(
            JSON.stringify(data)
          )}`
        );
      } else {
        ...
        setError(
          `Failed to get recommendations: ${response.status} ${response.statusText}. ${errorData}`
        );
      }
    } catch (error) {
      setError(
    ...
    <form onSubmit={handleSubmit} className="">
      <div className="flex flex-col w-4/5 mx-auto mt-5 block rounded-lg bg-white p-5 text-surface shadow-secondary-1">
        <h3 className="mb-5 text-lg font-medium text-gray-900 dark:text-white">
          Berapa anggaranmu untuk smartphone?
        </h3>
      ...
      <div className="flex flex-col w-4/5 mx-auto mt-5 block rounded-lg bg-white p-5 text-surface shadow-secondary-1">
        <h3 className="mb-5 text-lg font-medium text-gray-900 dark:text-white">
          Seberapa penting Prosessor Smartphone untuk kamu?
        </h3>
        <ul className="grid w-full gap-6 md:grid-cols-2">
          <li>
            <input
            ...
            >
              <div className="block">
                ...
                <div className="w-full">
                  Saya hanya menggunakan smartphone untuk internetan dan sosial
                  media
                </div>
              </div>
              <svg
          ...
          <li>
            ...
            >
              <div className="block">
                ...
                <div className="w-full">
                  Saya menggunakan smartphone lebih dari sekedar internetan dan
                  sosial media
                </div>
              </div>
              <svg
      ...
      <div className="flex flex-col w-4/5 mx-auto mt-5 block rounded-lg bg-white p-5 text-surface shadow-secondary-1">
        <h3 className="mb-5 text-lg font-medium text-gray-900 dark:text-white">
          Seberapa penting Kamera Smartphone untuk kamu?
        </h3>
        <ul className="grid w-full gap-6 md:grid-cols-2">
          <li>
            <input
      ...
      <div className="flex flex-col w-4/5 mx-auto mt-5 block rounded-lg bg-white p-5 text-surface shadow-secondary-1">
        <h3 className="mb-5 text-lg font-medium text-gray-900 dark:text-white">
          Banyak RAM yang diinginkan pada Smartphone?
        </h3>
        <ul className="grid w-full gap-6 md:grid-cols-2">
          <li>
            <input
      ...
      <div className="flex flex-col w-4/5 mx-auto mt-5 block rounded-lg bg-white p-5 text-surface shadow-secondary-1">
        <h3 className="mb-5 text-lg font-medium text-gray-900 dark:text-white">
          Penyimpanan yang dibutuhkan untuk smartphone?
        </h3>
        <ul className="grid w-full gap-6 md:grid-cols-2">
          <li>
            <input
